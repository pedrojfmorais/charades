...
class GameEvent with _$GameEvent {
  ...
  const factory GameEvent.toggleCategory(int index, bool isSelected) = ToggleCategory;
  ...
  const factory GameEvent.updateConfigs({int? countdownTime, int? gameDuration}) = UpdateConfigs;
}